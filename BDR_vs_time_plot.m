...
%%%%%%%%%%%%%%%%%%%%%%%
%loaded38MW
pulsenum38 = [2242600   2344050 6735700 4406450 2293000 636900  2960500 2743100 546700  3577000];%run1 from IPAC, no BDs in run3 and 5
BDs38 =      [4         19      13      27      1       7       17      40      26      7];
tstamps38 = {'08APR - 09APR','01JUL - 04JUL','14JUL - 18JUL',...
    '22JUL - 25JUL','29JUL - 31JUL','05AUG - 06AUG','12AUG - 14AUG',...
    '25AUG - 27AUG','08SEP - 12 SEP','18SEP - 21SEP'};
...
%%%%%%%%%%%%%%%%%%%%%%%
%Unloaded41MW
pulsenumU41 = [5469800   2514800 5902050 18411700   4206400 10535450]; %missing run5
BDsU41 =      [203       22      111     202        35      81];
tstampsU41 = {'30AUG - 02SEP','06SEP - 07SEP','12SEP - 15SEP','17OCT - 28OCT',...
                '02NOV - 04NOV','06NOV - 11NOV'};
...
%%%%%%%%%%%%%%%%%%%%%%%
%Unloaded38MW
pulsenumU38 = [1587050  5446800 1413200     3160450 1633300 58800   1323650 8633700];%missing run5
BDsU38 =      [15       96      44          50      36      4       10      84];
tstampsU38 = {'14JUL ','19JUL - 20JUL','25JUL - 26JUL','26JUL - 28JUL','28AUG - 29AUG',...
                '07SEP - 08SEP','07OCT - 08OCT','14NOV - 18NOV'};
